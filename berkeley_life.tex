...
\begin{minipage}{\textwidth}
  \begin{center}
    \includegraphics[width=0.49\textwidth]{grad_life/brew-fest}
    \includegraphics[width=0.49\textwidth]{grad_life/drakes-2018}\\
    \vspace{0.2cm}
    \includegraphics[width=0.39\textwidth]{grad_life/boardwalk}
    \includegraphics[width=0.2\textwidth]{grad_life/cheeseboard}
	\includegraphics[width=0.39\textwidth]{grad_life/womens-march}
  \end{center}
\end{minipage}
